...
class TaskWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.task_table.setHorizontalHeaderLabels(["순서", "완료", "할 일", "생성일", "액션"])
        ...
        header.setSectionResizeMode(4, QHeaderView.ResizeToContents)  # 액션
    ...
    def load_tasks(self):
        ...
        for row, task in enumerate(tasks):
            ...
            self.task_table.setItem(row, 3, date_item)
